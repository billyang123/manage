<template>
    <div class="founderComments">
        <h2 style="padding-top:20px">回复列表</h2>
                ...
                <el-form :inline="true" :model="formInline" class="demo-form-inline" label-width="100px">
                    ...
                    <el-col :span="6">
                        <el-form-item label="回复内容：">
                            <el-input v-model="formInline.cont" placeholder="回复内容"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="回复状态：">
                            <el-select v-model="formInline.region" placeholder="回复状态">
        ...
        <div class="founderTab" style="padding-top:30px;padding-bottom:60px">
            <el-table :data="tableData" border style="width: 100%" @selection-change="handleSelectionChange">
                ...
                <el-table-column inline-template label="回复ID" width="120">
                    <div>{{ row.id }}</div>
                </el-table-column>
                <el-table-column prop="userNickname" label="用户昵称" width="120">
                </el-table-column>
                <el-table-column prop="replyContent" label="回复内容" width="420">
                </el-table-column>
...
default {
    ...
    methods: {
        ...
        getUserData() {
            var self = this;
            this.$http.get(api.getFounderReplay + '?page=' + (this.currentPage - 1) + '&size=' + this.currentPageSize).then((data) => {
                console.log(data)
        ...
        handleDel() {
            ...
            $MsgBox.confirm('此操作将永久删除该评论, 是否继续?', '提示', {
                ...
                self.$http.post(api.getFounderReplayDel, {
                    commentReplyId: id
                }, {
                    emulateJSON: true,
                    headers: {

            ...
            <div v-for="item in founderMessage" class="founderMessage_item" style="border-bottom:1px solid #dddddd;padding-bottom:10px;margin-left:50px;margin-right:50px">
              ...
              <el-row>
                ...
                <el-col :span="4" :offset="8"><div class="grid-content bg-purple-light">
                  <el-button type="primary" :disabled="false" @click="handleCheck(item.id,item.messageStatus)">采纳</el-button>
                </div></el-col>
...
import api from '../api/api'
    export default{
      ...
      methods: {
          getUserData(){
          var self=this;
          this.$http.get(api.getFounderMessage+'?page='+this.currentPage+'&size='+this.currentPageSize).then((data) => {
            console.log(data)
